...
public class StoresRepositoryITContainer extends AbstractContainerBaseTest {
...
//                .build();
        ...
        savedStores.setEmail("san@gmail.com");
        savedStores.setFirstName("San");
        Stores updatedStores =  storeRepository.save(savedStores);

        // then - verify the output
        assertThat(updatedStores.getEmail()).isEqualTo("san@gmail.com");
        assertThat(updatedStores.getFirstName()).isEqualTo("San");
    }
